package com.theduck.todoapp.config;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    //private final String websocketRelayEndpoint;
    ...
    private final Endpoint websocketEndpoint = Endpoint.fromEndpointString(${custom.web-socket-relay-endpoint:#{null}});
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        TcpOperations<byte[]> customTcpClient = this.websocketUseSsl?
    ...
    private TcpOperations<byte[]> getCustomTcpClientWithoutSSLSupport() {
    ...
    private TcpOperations<byte[]> getCustomTcpClientWithSSLSupport() {
        return new ReactorNettyTcpClient<>(configurer -> configurer
                .host(this.websocketEndpoint.host)
